...
return {
    config = function(table)
        ...
        -- vim.cmd.hi({ "GitSignsAdd", "guibg=none", "ctermbg=none", bang = true })
        -- vim.cmd.hi({ "GitSignsChange", "guibg=none", "ctermbg=none", bang = true })
        -- vim.cmd.hi({ "GitSignsDelete", "guibg=none", "ctermbg=none", bang = true })
